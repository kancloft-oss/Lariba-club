                        ...
                        <div className="flex-1">
                          ...
                          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div className="space-y-1">
                              <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider">Детали</p>
                            ...
                            {code.frequencyType !== 'once' && (
                              <div className="space-y-1">
                                <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider">Статус</p>
                                <p className={`text-xs font-bold flex items-center ${isDoneToday ? 'text-emerald-600' : 'text-zinc-400'}`}>
                                  {isDoneToday ? (
